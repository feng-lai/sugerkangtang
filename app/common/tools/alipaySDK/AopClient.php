...
namespace app\common\tools\alipaySDK;
...
//        var_dump($totalParams);die;
        ...
        if ("GET" == strtoupper($httpmethod)) {
            ...
            //拼接表单字符串
//            var_dump($this->buildRequestForm($totalParams));die;
    ...
    public function execute($request, $authToken = null, $appInfoAuthtoken = null)
    {
        ...
        $this->setupCharsets($request);
//        var_dump($this->fileCharset);
//        var_dump($this->postCharset);die;
...
//        $r = iconv($this->postCharset, $this->fileCharset . "//IGNORE", $resp);
        $r = $this->characet($resp,$this->postCharset);
//        $r = "{
//    \"alipay_trade_refund_response\": {
//        \"code\": \"10000\",
//        \"msg\": \"Success\",
//        \"buyer_logon_id\": \"158******34\",
//        \"buyer_user_id\": \"2088702974052550\",
//        \"fund_change\": \"Y\",
//        \"gmt_refund_pay\": \"2020-11-14 16:27:13\",
//        \"out_trade_no\": \"a21e0af9b484e08cb38795c66ed3f84f\",
//        \"refund_fee\": \"1.00\",
//        \"send_back_fee\": \"0.00\",
//        \"trade_no\": \"2020111422001452551422787738\"
//    },
//    \"sign\": \"\"
//}";
        $signData = null;
...
//        var_dump($params);die;
    ...
    {
//        var_dump($this->alipayPublicKey);die;
